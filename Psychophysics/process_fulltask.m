...
for i=1:length(BehavDat)
	...
	if Summary{i,2} == '99'
		l = 1;
	elseif Summary{i,2} == '01'
		l = 2;
	elseif Summary{i,2} == '03'
		l = 3;
	elseif Summary{i,2} == '05'
		l = 4;
	elseif Summary{i,2} == '07'
		l = 5;
	elseif Summary{i,2} == '09'
		l = 6;
	elseif Summary{i,2} == '10'
		l = 7;
	elseif Summary{i,2} == '12'
		l = 8;
	else
